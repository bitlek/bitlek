...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitlek " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitlektools.com", "dnsseed.bitlektools.com"},
    {"bitlekpool.org", "dnsseed.bitlekpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"bitlektools.com", "testnet-seed.bitlektools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitlek is probably already running."), addrBind.ToString().c_str());
        else
